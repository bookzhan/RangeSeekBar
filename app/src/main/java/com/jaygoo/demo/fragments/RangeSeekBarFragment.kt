...
class RangeSeekBarFragment : BaseFragment() {
    lateinit var sb_range_1: RangeSeekBar
    lateinit var sb_range_2: RangeSeekBar
    lateinit var sb_range_3: RangeSeekBar
    lateinit var sb_range_4: RangeSeekBar
    lateinit var sb_range_5: RangeSeekBar
    lateinit var sb_range_6: RangeSeekBar
    lateinit var sb_range_8: RangeSeekBar
    override fun getLayoutId(): Int {
        return R.layout.fragment_range
    }

    override fun initView(view: View) {
        sb_range_1 = view.findViewById(R.id.sb_range_1)
        sb_range_2 = view.findViewById(R.id.sb_range_2)
        sb_range_3 = view.findViewById(R.id.sb_range_3)
        sb_range_4 = view.findViewById(R.id.sb_range_4)
        sb_range_5 = view.findViewById(R.id.sb_range_5)
        sb_range_6 = view.findViewById(R.id.sb_range_6)
        sb_range_8 = view.findViewById(R.id.sb_range_8)
